...
local redzlib = {
	Themes = {
		Darker = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(5, 10, 25)),  -- Azul marino profundo
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(25, 50, 100)),  -- Azul medio vibrante
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(5, 10, 25))   -- Azul marino profundo
			}),
			["Color Hub 2"] = Color3.fromRGB(10, 30, 60),  -- Azul oscuro suave
			["Color Stroke"] = Color3.fromRGB(15, 40, 90),  -- Azul con brillo sutil
			["Color Theme"] = Color3.fromRGB(0, 135, 255),  -- Azul brillante intenso
			["Color Text"] = Color3.fromRGB(250, 250, 255),  -- Blanco frío
			["Color Dark Text"] = Color3.fromRGB(180, 200, 230)  -- Gris azulado claro
		},
		Dark = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(10, 20, 45)),  -- Azul oscuro fresco
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(40, 80, 160)),  -- Azul claro medio
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(10, 20, 45))   -- Azul oscuro fresco
			}),
			["Color Hub 2"] = Color3.fromRGB(20, 40, 90),  -- Azul suave medio
			["Color Stroke"] = Color3.fromRGB(30, 60, 130),  -- Azul con brillo medio
			["Color Theme"] = Color3.fromRGB(0, 175, 240),  -- Azul vibrante
			["Color Text"] = Color3.fromRGB(240, 245, 255),  -- Blanco con tono azulado suave
			["Color Dark Text"] = Color3.fromRGB(160, 180, 210)  -- Gris azulado oscuro
		},
		BlueElegant = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(10, 25, 55)),  -- Azul oscuro elegante
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(30, 70, 150)),  -- Azul vivo medio
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(10, 25, 55))   -- Azul oscuro elegante
			}),
			["Color Hub 2"] = Color3.fromRGB(15, 35, 80),  -- Azul elegante profundo
			["Color Stroke"] = Color3.fromRGB(20, 55, 120),  -- Azul con un brillo elegante
			["Color Theme"] = Color3.fromRGB(0, 120, 220),  -- Azul intenso elegante
			["Color Text"] = Color3.fromRGB(255, 255, 255),  -- Blanco puro
			["Color Dark Text"] = Color3.fromRGB(200, 220, 250)  -- Gris suave con tono frío
		}
	},
	Info = {
		Version = "1.1.0"
	...
	Flags = {},
	Tabs = {},
	Icons = loadstring(game:HttpGet("https://raw.githubusercontent.com/MyNameIsObitoUchiha/UI_Libarys/refs/heads/main/Lucide%20Icons"))()
}
